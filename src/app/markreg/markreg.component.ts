...
export class MarkregComponent implements OnInit {
  ...
  genders=[
    ...
    getCountry(cData){
        ...
        this.httpClient.get('http://13.233.121.99:8111/state1/books').subscribe((res1)=>{
    ...
    var id = sData.id;
     this.stateName = sData.name;
      ...
      this.httpClient.get('http://13.233.121.99:8111/city1/books').subscribe((res2)=>{
          debugger;
    ...
    ngOnInit() {
     // this.countryLoad();
      this.httpClient.get('http://13.233.121.99:8111/country1/books').subscribe((res)=>{
  ...
  onSubmit() {
    ...
    this.httpClient.post("http://13.233.121.99:8111/marketingregistrationservice/books",
    {"name": this.name,
